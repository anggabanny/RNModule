...
function App(): JSX.Element {
  ...
  const onPress = async () => {
    // CalendarModule.createCalendarEvent((res:any)=> console.log(res)) //callback
    try {
      ...
      <ScrollView
        ...
        <View
          ...
          <Section title="Step One">
            Edit <Text onPress={onPress} style={styles.highlight}>App.tsx</Text> to change this
